  ...
  return (
    <div className="min-h-screen w-full relative bg-gradient-to-tr from-[#edeafd] via-[#d6d1f5] to-[#b5b6eb] dark:from-[#1a1436] dark:via-[#311F70] dark:to-[#381279] transition-colors duration-300">
      ...
      <div className="fixed top-4 right-6 z-40">
        <button
          className="px-4 py-2 rounded-full bg-white/60 dark:bg-black/30 border border-purple-300/30 text-purple-900 dark:text-purple-200 font shadow-md hover:bg-white/80 dark:hover:bg-black/50 transition"
          onClick={() => setDark((d) => !d)}
        >
          {dark ? '⏻' : '⏻'}
        </button>
